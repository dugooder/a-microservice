...
namespace FluentData
{
	...
	internal class PropertyExpressionParser<T>
	{
		...
		static PropertyInfo GetProperty(Expression<Func<T, object>> exp)
		{
			PropertyInfo result;
	...
	{
		static readonly ConcurrentDictionary<Type, Dictionary<string, PropertyInfo>> _cachedProperties = new ConcurrentDictionary<Type, Dictionary<string, PropertyInfo>>();
		...
		static Dictionary<string, PropertyInfo> BuildPropertyDictionary(Type type)
		{
	...
	{
		static Dictionary<Type, DataTypes> _types;
